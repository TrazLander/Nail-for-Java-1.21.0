...
execute if entity @r[scores={TCrandom=0},x=3,y=213,z=17,dx=0,dy=0,dz=0] run scoreboard players add fake! TCrandom 1
execute if entity @r[scores={TCrandom=0},x=3,y=213,z=19,dx=0,dy=0,dz=0] run scoreboard players add fake! TCrandom 1
...
execute if entity @a[scores={TCrandom=3}] run scoreboard players set fake3! TCrandom 1
execute if entity @a[scores={TCrandom=4}] run scoreboard players set fake4! TCrandom 1
execute if entity @a[scores={TCrandom=5}] run scoreboard players set fake5! TCrandom 1
execute if entity @a[scores={TCrandom=6}] run scoreboard players set fake6! TCrandom 1
execute if entity @a[scores={TCrandom=7}] run scoreboard players set fake7! TCrandom 1
execute if entity @a[scores={TCrandom=8}] run scoreboard players set fake8! TCrandom 1
execute if entity @a[scores={TCrandom=9}] run scoreboard players set fake9! TCrandom 1
execute if entity @a[scores={TCrandom=10}] run scoreboard players set fake10! TCrandom 1
execute if entity @a[scores={TCrandom=11}] run scoreboard players set fake11! TCrandom 1
execute if entity @a[scores={TCrandom=12}] run scoreboard players set fake12! TCrandom 1
execute if entity @a[scores={TCrandom=13}] run scoreboard players set fake13! TCrandom 1
execute if entity @a[scores={TCrandom=14}] run scoreboard players set fake14! TCrandom 1
execute if entity @a[scores={TCrandom=15}] run scoreboard players set fake15! TCrandom 1
execute if entity @a[scores={TCrandom=16}] run scoreboard players set fake16! TCrandom 1

# turn on lamps for occupied cells
execute if entity @a[scores={TCrandom=3}] run fill 266 24 2238 266 24 2238 redstone_block
execute if entity @a[scores={TCrandom=4}] run fill 269 24 2238 269 24 2238 redstone_block
execute if entity @a[scores={TCrandom=5}] run fill 263 24 2238 263 24 2238 redstone_block
execute if entity @a[scores={TCrandom=6}] run fill 272 24 2238 272 24 2238 redstone_block
execute if entity @a[scores={TCrandom=7}] run fill 260 24 2238 260 24 2238 redstone_block
execute if entity @a[scores={TCrandom=8}] run fill 275 24 2238 275 24 2238 redstone_block
execute if entity @a[scores={TCrandom=9}] run fill 257 24 2238 257 24 2238 redstone_block
execute if entity @a[scores={TCrandom=10}] run fill 278 24 2238 278 24 2238 redstone_block
execute if entity @a[scores={TCrandom=11}] run fill 254 24 2238 254 24 2238 redstone_block
execute if entity @a[scores={TCrandom=12}] run fill 281 24 2238 281 24 2238 redstone_block
execute if entity @a[scores={TCrandom=13}] run fill 251 24 2238 251 24 2238 redstone_block
execute if entity @a[scores={TCrandom=14}] run fill 284 24 2238 284 24 2238 redstone_block
execute if entity @a[scores={TCrandom=15}] run fill 248 24 2238 248 24 2238 redstone_block
execute if entity @a[scores={TCrandom=16}] run fill 287 24 2238 287 24 2238 redstone_block

# set current team captain
execute if entity @p[scores={TCrandom=0..}] run scoreboard players set fakeTC! TCrandom 1
# opens team captain 1 gate
execute if entity @p[scores={TCrandom=0..}] run fill 264 23 2245 264 23 2245 stone replace redstone_block

# over max players
execute if entity @p[scores={TCrandom=0}] run tellraw @a [{"text":"16 players max. You were not chosen "},{"selector":"@a[scores={TCrandom=0}]"}]
scoreboard players set @a[scores={TCrandom=0}] TCrandom -2

# reset if only spectators
execute unless entity @p[scores={TCrandom=0..}] run scoreboard players set @a[scores={TCrandom=-2}] TCrandom -3
execute if entity @p[scores={TCrandom=-3}] run tellraw @a {"text":"-Zero valid players found for the Team Captain System to activate.","italic":true,"color":"gray"}
execute if entity @p[scores={TCrandom=-3}] run function nail:tc_system/tc_system_reset

# set extras to spectator box
tp @a[scores={TCrandom=-2}] 268 32 2250 180 0

# if only team captains and no players, run tc system anyway
execute unless entity @a[scores={TCrandom=3..16}] run function nail:tc_system/lane_selection_open
