...
execute as @a[scores={TCrandom=3}] run fill 177 145 2161 177 145 2161 redstone_block replace stone
execute as @a[scores={TCrandom=4}] run fill 177 145 2162 177 145 2162 redstone_block replace stone
execute as @a[scores={TCrandom=5}] run fill 177 145 2163 177 145 2163 redstone_block replace stone
execute as @a[scores={TCrandom=6}] run fill 177 145 2164 177 145 2164 redstone_block replace stone
execute as @a[scores={TCrandom=7}] run fill 177 145 2165 177 145 2165 redstone_block replace stone
execute as @a[scores={TCrandom=8}] run fill 177 145 2166 177 145 2166 redstone_block replace stone
execute as @a[scores={TCrandom=9}] run fill 177 145 2167 177 145 2167 redstone_block replace stone
execute as @a[scores={TCrandom=10}] run fill 177 145 2168 177 145 2168 redstone_block replace stone
execute as @a[scores={TCrandom=11}] run fill 177 145 2169 177 145 2169 redstone_block replace stone
execute as @a[scores={TCrandom=12}] run fill 177 145 2170 177 145 2170 redstone_block replace stone
execute as @a[scores={TCrandom=13}] run fill 177 145 2171 177 145 2171 redstone_block replace stone
execute as @a[scores={TCrandom=14}] run fill 177 145 2172 177 145 2172 redstone_block replace stone
execute as @a[scores={TCrandom=15}] run fill 177 145 2173 177 145 2173 redstone_block replace stone
execute as @a[scores={TCrandom=16}] run fill 177 145 2174 177 145 2174 redstone_block replace stone
...
# turn on TC drop
execute as @p[scores={TCrandom=1..16}] run fill 177 149 2161 177 149 2161 redstone_block replace stone
...
execute as @p[scores={TCrandom=-2}] run execute as @a[scores={TCrandom=-2}] run fill 177 157 2161 177 157 2161 redstone_block replace stone
