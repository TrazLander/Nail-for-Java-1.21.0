...
execute if score fake! Rand matches 0 run function nail:teams_system/randomizer_3_finish
execute if score fake! Rand matches 1 run function nail:teams_system/randomizer_2_randomize