...
execute if score fake! temp matches 5 run function nail:teams_system/randomizer_1_load
...
execute if score fake! temp matches 6 run function nail:tc_system/tc_system_startup
# remove temp
