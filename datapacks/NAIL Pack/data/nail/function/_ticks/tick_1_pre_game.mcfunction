...
execute if score fake! MapMode matches 1..2 run execute if score t1lever levers matches 0 run execute if block -3 213 48 minecraft:lever[powered=true] run function nail:game/ready/t1_ready
...
execute if score fake! MapMode matches 1..2 run execute if score t2lever levers matches 0 run execute if block -3 213 46 minecraft:lever[powered=true] run function nail:game/ready/t2_ready
