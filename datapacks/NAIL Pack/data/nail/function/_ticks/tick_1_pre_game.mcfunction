...
execute if score fake! MapMode matches 1..2 run execute unless score t1lever levers matches 1 run execute if block -3 213 48 minecraft:lever[powered=true] run function nail:game/ready/t1_ready
execute if score fake! MapMode matches 1..2 run execute if score t1lever levers matches 1 run execute unless block -3 213 48 minecraft:lever[powered=true] run function nail:game/ready/t1_unready

execute if score fake! MapMode matches 1..2 run execute unless score t2lever levers matches 1 run execute if block -3 213 46 minecraft:lever[powered=true] run function nail:game/ready/t2_ready
execute if score fake! MapMode matches 1..2 run execute if score t2lever levers matches 1 run execute unless block -3 213 46 minecraft:lever[powered=true] run function nail:game/ready/t2_unready
...
execute if block -3 213 18 minecraft:stone_button[powered=true] run function nail:game/teams_system/teams_system_load
# team captain system button pressed
execute if block 3 214 18 minecraft:stone_button[powered=true] run function nail:game/teams_system/teams_system_load