# tnt board
execute if score team! TNTboard matches 1 run function nail:game/t1_tnt_board
execute if score team! TNTboard matches 2 run function nail:game/t2_tnt_board
