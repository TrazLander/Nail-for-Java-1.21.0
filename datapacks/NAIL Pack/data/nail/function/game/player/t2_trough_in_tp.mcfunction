...
execute if score Tick! T2StartTimer matches 0.. run execute if score fake! gamestatus matches 2 run tp @a[scores={Teams=12}] 0.0 212 46 0 0
execute unless score Tick! T2StartTimer matches 0.. run execute if score fake! gamestatus matches 2 run tp @a[scores={Teams=12}] 0.0 208 34 0 0
