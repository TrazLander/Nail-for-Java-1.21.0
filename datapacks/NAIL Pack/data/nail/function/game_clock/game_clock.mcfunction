...
execute if score fake! TimerTicks matches 19 run function nail:game_clock/second1
# second2
...
execute if score fake! TimerSecs1 matches 9 run function nail:game_clock/second2
# minute1
...
execute if score fake! TimerSecs2 matches 5 run function nail:game_clock/minute1
# minute2
...
execute if score fake! TimerMins1 matches 9 run function nail:game_clock/minute2